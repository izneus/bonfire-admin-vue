  ...
  <div class="panel-tab__content">
    <el-form size="mini" label-width="90px" @submit.native.prevent>
      ...
      <template v-if="elementBaseInfo.$type === 'bpmn:Process'">
        ...
        <!--          <el-input v-model="elementBaseInfo.description" clearable @change="updateBaseInfo('description')" />-->
        <!--        </el-form-item>-->
...
export default {
  ...
  methods: {
    resetBaseInfo() {
      ...
      // 处理bpmn:Process的$attrs里的参数
      /* if (this.elementBaseInfo && this.elementBaseInfo.$type === 'bpmn:Process') {
        const bo = this.bpmnElement.businessObject
        if ('$attrs' in bo) {
          this.$set(this.elementBaseInfo, 'description', bo.$attrs.description)
        } else {
          this.$set(this.elementBaseInfo, 'description', null)
        }
      }*/
