    ...
    <div class="my-process-designer__header">
      ...
      <template v-if="!$slots['control-header']">
        <el-button-group key="file-control">
          <el-button :size="headerButtonSize" :type="headerButtonType" icon="el-icon-folder-opened" @click="saveModel">保存流程</el-button>
...
export default {
  ...
  watch: {
    value: function(newValue, oldValue) { // 在 xmlString 发生变化时，重新创建，从而绘制流程图
